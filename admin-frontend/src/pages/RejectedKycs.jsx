...
export default function RejectedKyc() {
  ...
  const rejectedUsers = kycDocs.filter((u) => u.kycStatus === "rejected");
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-6 md:p-8">
        <h1 className="text-3xl font-bold mb-6 text-gray-800">Rejected KYC Users</h1>
        ...
        <div className="md:hidden space-y-4">
          {rejectedUsers.length > 0 ? (
            ...
            <p className="text-center text-gray-500">No rejected KYC users yet.</p>
          )}
        </div>
      </div>
    </div>
